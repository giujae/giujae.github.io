...
- 삭제 :  
  ...
  - Black이 삭제될 때 : 2, 4, 5번 속성이 위반 될 수 있다.
    ...
    - 5번 속성이 위반 : 삭제 된 색의 위치를 대체한 노드에 extra black을 부여한다.
      ...
      ![delete](../assets/img/post_img/20240802/delete.png){: style="display: block; margin-left: auto; margin-right: auto; width: 40%;" }

      > doubly black : extra black이 부여된 black 노드.

      ![delete](../assets/img/post_img/20240802/delete2.png){: style="display: block; margin-left: auto; margin-right: auto; width: 40%;" }
